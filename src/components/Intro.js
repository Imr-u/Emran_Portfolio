      ...
      <div className="intro-content">
        <div className="typist-content">
          <div className="text-typing-container" style={{ position: "relative" }}>
            ...
            <span className="intro-name" ref={nameRef}>Emran.</span>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 248 248">
                ...
                <defs>
                  <linearGradient id="windmill-gradient-1" x1="218" x2="-47.283" y1="258" y2="153.706" gradientUnits="userSpaceOnUse">
                    <stop offset=".27" stopColor="#f97316"></stop>
        ...
        <div className="intro-subtitle" ref={subtitleRef}>
          <span className="intro-subtitle-name">Data Engineer | Data Scientist |Data Analyst.</span> 
        </div>
        
        <div className="intro-desc" ref={descRef}>
         I build data systems that solve complex problems and turn information into actionable insights.
          I work well in teams but also enjoy diving deep into data challenges, always aiming to deliver real, measurable impact.
        </div>
