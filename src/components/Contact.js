...
export default function Contact() {
  ...
  const yourEmail = "abukiemran@gmail.com";
  ...
  return (
    <section id="contact" ref={contactSectionRef}>
      ...
      <p>
        I'm currently focused on Data Engineering, building scalable data pipelines and automated workflows. I’m open to opportunities in this field and always happy to connect with like-minded professionals. If you have a role, project, or collaboration in mind, I’d love to hear from you!
      </p>  
      </div>
